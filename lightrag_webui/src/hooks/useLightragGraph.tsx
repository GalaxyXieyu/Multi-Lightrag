...
import { useBackendState, useGraphState } from '@/stores/state'
...
const useLightrangeGraph = () => {
  ...
  }, [queryLabel, maxQueryDepth, maxNodes, isFetching, t, useGraphState((state) => state.currentGraph)])
  ...
  useEffect(() => {
    const handleNodeExpand = async (nodeId: string | null) => {
      ...
      try {
        ...
        console.log(`Node expansion - Current graph:`, currentGraph);
        console.log(`Node expansion - Graph ID: ${graphId}`);
